...
1. Носители импланта лояльности не должны причинять вред корпорации, они полностью лояльны политике НаноТрейзен и должны действовать в её интересах. Им также запрещено пытаться извлечь имплант самостоятельно или допускать его несанкционированное извлечение. 
   - От лоялистов ожидается соблюдение (насколько это позволяет ситуация)  корпоративных регуляций и космозакона, однако они могут уйти на второй план в исключительных случаях, уступая истинным интересам НаноТрейзен. 
   - Генокрады (а в особых ситуациях - воксы) способны сопротивляться действию импланта. Об этой особенности воксов экипаж не знает.
